...
public class ReservationControllerTest {
	...
	*/
	@Test
	public void 未ログイン場合は会員用の予約一覧ページからログインページにリダイレクトする()
			throws Exception{
	...
	public void ログイン済みの場合は会員用の予約一覧ページが正しく表示される()
			throws Exception{
	...
	@Test
	public void 未ログインの場合は予約フォームを送信せずにログインページにリダイレクトする()
			throws Exception{
	...
	@Test
	@WithUserDetails("taro.samurai@example.com")
	public void ログイン済みの場合は予約フォームの送信後に予約内容の確認ページにリダイレクトする()
			throws Exception{
	...
	@Test
	public void 未ログインの場合は予約内容の確認ページからログインページにリダイレクトする()
			throws Exception{
	...
	@Test
	@WithUserDetails("taro.samurai@example.com")
	public void ログイン済みの場合は予約内容の確認ページが正しく表示される()
			throws Exception{
	...
	@WithUserDetails("taro.samurai@example.com")
	@Transactional
	public void ログイン済みの場合は予約後に会員用の予約一覧ページにリダイレクトする()
			throws Exception{
